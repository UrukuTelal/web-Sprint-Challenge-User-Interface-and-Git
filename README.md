...
Semantic HTML is about meaning, not the presentation, save how it looks for your CSS.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

A 'display: block;' always takes a newline, and fills the horizontal, 'inline' does not.
...
Git allows easy control of the Version, by allowing individual developers to fork and create their own branches of code, expanding upon the master, without messing it up.
